...
BOT_TOKEN = "8662232657:AAGijv9vG0-6GW0rYaAIjKkBmWMq5AJy64Y"
API_KEY = "MURAD_B0AD7D4474B5425202FAE0DD"
...
OTP_GROUP_ID = -1003949696136

# ==================== WELCOME MESSAGE CONFIGURATION ====================
WELCOME_MESSAGE = """✨ 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 FastxOTPAgent BOT"""
...
async def fast_allocate_number(query, context, range_text, sid):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📢 OTP GROUP", url="https://t.me/BDTopSMSRCV", style="primary")]
    ])
    try:
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "💬 SUPPORT":
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("💬 SUPPORT", url=https://t.me/mdrubel2m, style="primary")],
            [InlineKeyboardButton("👨‍💻 DEVELOPER BY", url=https://t.me/mdrubel2m, style="danger")]
        ])
